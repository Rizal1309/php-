...
<head>
  ...
  <title>Pengaduan - Pesan Pengaduan</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800">Pesan Pengaduan Baru</h1>
          </div>
              ...
              <div class="card-body">
                  ...
                  if(isset($_GET['pesan'])){
                    if($_GET['pesan'] == "gagal"){
                     echo "<div class='alert alert-danger' role='alert'>
                            Data gagal dikirim. Pastikan anda sudah mengisinya dengan benar.
                          </div>";
                    }
                      ...
                      echo "<div class='alert alert-success alert-dismissible' role='alert'>
                            <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                             <span aria-hidden='true'>&times;</span>
                              ...
                              Selamat! Balasan berhasil dikirim.
                            </div>";                   
                    }
                ...
                ?>
                  ...
                  <?php
                      include '../koneksi.php';
                      $no = 1;
                      $data = mysqli_query($koneksi,"SELECT * FROM tbl_pengaduan JOIN tbl_masyarakat USING(id_masyarakat)
                                           WHERE id_pengaduan NOT IN (SELECT id_pengaduan FROM tbl_tanggapan)");
                      while($row = mysqli_fetch_array($data))
                      {
                          ...
                          <td>".$row['nama']."</td>
                          <td>
                            <a class='btn btn-sm btn-primary' href='balas-pengaduan.php?id=".$row['id_pengaduan']."'>
                            <i class='fa fa-comment'></i> Balas </a>
                          </td>
                      </tr>";
                      $no++;
                      }
