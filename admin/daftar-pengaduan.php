...
<head>
  ...
  <title>Pengaduan - Daftar Pengaduan</title>
            ...
            <div class="card mb-4">
              <div class="card-body">
                <div class="row col-lg-12">
                  <a href="cetak-daftar-pengaduan.php" class="btn btn-sm btn-info btn-icon-split">
                ...
                ?>
                  ...
                  <?php
                      ...
                      $data = mysqli_query($koneksi,"select * from tbl_pengaduan JOIN tbl_masyarakat USING(id_masyarakat) JOIN tbl_tanggapan USING (id_pengaduan)");
                      ...
                      { 
                          ...
                          <td>
                            <a class='btn btn-sm btn-info' href='detail-pengaduan.php?id=".$row['id_pengaduan']."'> Detail </a>
