            ...
            <div class="card mb-4">
              <div class="card-body">
                <div class="row col-lg-12">
                  <a href="cetak-daftar-masyarakat.php" class="btn btn-sm btn-info btn-icon-split">
                ...
                ?>
                  ...
                  <?php
                      include '../koneksi.php';
                      $no = 1;
                      $data = mysqli_query($koneksi,"select * from tbl_masyarakat");
                      ...
                      { 
                          ...
                          <td>".$row['email']."</td>
                          <td>
                            <a class='btn btn-sm btn-info' href='detail-masyarakat.php?id=".$row['id_masyarakat']."'> Detail </a>                          </td>
                      </tr>";
                      $no++;
                      }
                  ?>
