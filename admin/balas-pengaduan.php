...
<head>
  ...
  <title>Pengaduan - Balas Pengaduan</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800">Balas Pengaduan <?php echo $row['subjek_pengaduan'];?></h1>
          </div>
              ...
              <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-7">
                       <label class="text-default"><?php echo $row['tgl_pengaduan'];?> </label>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-3">
                  ...
                  <!-- balasan -->
                  <form action="add-tanggapan.php" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                     <h5 class="text-secondary"><b>Balasan</b></h5>
                    </div>
                    <div class="form-group row">
                        <input type="hidden" value="<?php echo $_SESSION['idp'];?>" name="IdPetugas"/>
                        <input type="hidden" value="<?php echo $_GET['id'];?>" name="IdPengaduan"/>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-3">
                        <label for="tgl" class="text-primary">Status</label>
                      </div>
                      <div class="col-lg-7">
                    ...
                    <div class="form-group row">
                      <div class="col-lg-3">
                       <label for="subjek" class="text-primary">Isi Tanggapan</label>
                      </div>
                      <div class="col-lg-7">
                       <textarea class="form-control" name="isitanggapan"></textarea>
                      </div>
                    </div>
                    </div>
                    <br>
                    <center>
                    <button type="submit" name="balas" class="btn btn-sm btn-success" >Kirim Balasan</button>
                    <a href="pesan-pengaduan.php" class="btn btn-sm btn-dark">Kembali</a> &nbsp;
                    </center>
                    <br>
                  <!-- end balasan -->
                  </form>
