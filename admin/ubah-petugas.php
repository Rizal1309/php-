...
<head>
  ...
  <title>Pengaduan - Ubah Petugas</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800">Ubah Data Petugas</h1>
          </div>
                ...
                <div class="card-body">
                  <form action="update-petugas.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-7">
                      <input type="text" value="<?php echo $row['telepon'] ;?>" name="telepon" class="form-control"/>
                      <input type="hidden" value="<?php echo $row['id_petugas'] ;?>" name="IdPetugas" class="form-control"/>
                      </div>
                    </div>
                    <center>
