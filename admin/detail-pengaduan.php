<?php 
  ...
  $id = $_GET['id'];
  $data = mysqli_query($koneksi,"select * from tbl_pengaduan JOIN tbl_masyarakat USING (id_masyarakat) where id_pengaduan='$id'");
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800">Detail Tanggapan Pengaduan <?php echo $row['subjek_pengaduan'];?></h1>
          </div>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <form action="add-pengaduan.php" method="post" enctype="multipart/form-data">
                    ...
                    <a class='btn btn-sm btn-info' href='cetak-pengaduan.php?id=<?php echo $row['id_pengaduan'];?>'> Cetak</a>
                    <a class='btn btn-sm btn-danger' href='daftar-pengaduan.php'> Kembali </a>
                    <hr>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-7">
                       <label class="text-default"><?php echo $row['nama'] ;?> (<?php echo $row['email'] ;?>) </label>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-3">
                  ...
                  <?php 
                    ...
                    if ($cek == 0){
                      ...
                      <i class='fa fa-3x fa-frown'></i><br>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-7">
                       <label class="text-default"><?php echo tgl_indo($r['tgl_balas_tanggapan']);?> </label>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-3">
