      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800">Konfirmasi Hapus Pengaduan <?php echo $row['subjek_pengaduan'];?></h1>
          </div>
                ...
                <div class="card-body">
                  <form action="add-pengaduan.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-7">
                       <label class="text-default"><?php echo $row['isi_pengaduan'];?> </label>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-3">
                    ...
                    <br>
                    <center>
                    <a class='btn btn-sm btn-danger' href='del-pengaduan.php?id=<?php echo $row['id_pengaduan'];?>'> Hapus</a> &nbsp;
                    </center>
                    <hr>
                  </form>
                </div>
